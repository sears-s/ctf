...
public class HolderFragment extends Fragment implements ViewModelStoreOwner {
    ...
    static class HolderFragmentManager {
        private ActivityLifecycleCallbacks mActivityCallbacks = new EmptyActivityLifecycleCallbacks() {
            public void onActivityDestroyed(Activity activity) {
                if (((HolderFragment) HolderFragmentManager.this.mNotCommittedActivityHolders.remove(activity)) != null) {
                    ...
                    sb.append(activity);
                    Log.e(HolderFragment.LOG_TAG, sb.toString());
                }
            }
        };
        ...
        public HolderFragment holderFragmentFor(FragmentActivity activity) {
            ...
            HolderFragment holder2 = (HolderFragment) this.mNotCommittedActivityHolders.get(activity);
            if (holder2 != null) {
                return holder2;
            }
        ...
        public HolderFragment holderFragmentFor(Fragment parentFragment) {
            ...
            HolderFragment holder2 = (HolderFragment) this.mNotCommittedFragmentHolders.get(parentFragment);
            if (holder2 != null) {
                return holder2;
            }
