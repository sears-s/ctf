...
class LifecycleDispatcher {
    ...
    static class FragmentCallback extends FragmentLifecycleCallbacks {
        ...
        public void onFragmentCreated(FragmentManager fm, Fragment f, Bundle savedInstanceState) {
            ...
            if (f instanceof LifecycleRegistryOwner) {
                ...
                String str = LifecycleDispatcher.REPORT_FRAGMENT_TAG;
                if (childFragmentManager.findFragmentByTag(str) == null) {
                    f.getChildFragmentManager().beginTransaction().add((Fragment) new DestructionReportFragment(), str).commit();
                }
            }
        }
    ...
    public static void markState(FragmentActivity activity, State state) {
