...
public interface CMCObjectIdentifiers {
    ...
    static {
        String str = "7";
        id_cmc = id_pkix.branch(str);
        String str2 = "3";
        id_cmc_identityProof = id_cmc.branch(str2);
        String str3 = "2";
        id_cmc_identification = id_cmc.branch(str3);
        id_cmc_recipientNonce = id_cmc.branch(str);
        id_cct_PKIData = id_cct.branch(str3);
        id_cct_PKIResponse = id_cct.branch(str2);
    }
}
