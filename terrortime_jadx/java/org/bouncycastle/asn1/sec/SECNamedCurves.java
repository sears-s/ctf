...
public class SECNamedCurves {
    ...
    static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            GLVTypeBParameters gLVTypeBParameters = new GLVTypeBParameters(new BigInteger("9ba48cba5ebcb9b6bd33b92830b2a2e0e192f10a", 16), new BigInteger("c39c6c3b3a36d7701b9c71a1f5804ae5d0003f4", 16), new BigInteger[]{new BigInteger(str, 16), new BigInteger("-96341f1138933bc2f505", 16)}, new BigInteger[]{new BigInteger("127971af8721782ecffa3", 16), new BigInteger(str, 16)}, new BigInteger("9162fbe73984472a0a9d0590", 16), new BigInteger("96341f1138933bc2f503fd44", 16), CipherSuite.TLS_PSK_WITH_NULL_SHA256);
    ...
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            F2m f2m = new F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, valueOf, valueOf2, access$000, valueOf3);
            ECCurve access$100 = SECNamedCurves.configureCurve(f2m);
    ...
    static X9ECParametersHolder sect163r1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            F2m f2m = new F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, access$000, access$0002, access$0003, valueOf);
            ECCurve access$100 = SECNamedCurves.configureCurve(f2m);
    ...
    static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            F2m f2m = new F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, valueOf, access$000, access$0002, valueOf2);
            ECCurve access$100 = SECNamedCurves.configureCurve(f2m);
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(4);
            F2m f2m = new F2m(239, (int) CipherSuite.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, bigInteger, valueOf, access$000, valueOf2);
            ECCurve access$100 = SECNamedCurves.configureCurve(f2m);
