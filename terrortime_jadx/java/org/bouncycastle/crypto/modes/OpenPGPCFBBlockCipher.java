        ...
        if (i + i4 > bArr.length) {
            ...
            if (i5 > i4) {
                ...
                while (i6 < this.blockSize) {
                    ...
                    int i12 = i6 - 2;
                    int i13 = i2 + i6;
                    byte encryptByte3 = encryptByte(bArr[i + i6], i12);
                    bArr2[i13] = encryptByte3;
                ...
                if (i5 != 0) {
                    if (i5 == i4) {
                        ...
                        while (true) {
                            ...
                            int i14 = i6 - 2;
                            int i15 = i2 + i6;
                            byte encryptByte4 = encryptByte(bArr[i + i6], i14);
                            bArr2[i15] = encryptByte4;
                            bArr7[i14] = encryptByte4;
                            i6++;
                        }
                    }
                } else {
