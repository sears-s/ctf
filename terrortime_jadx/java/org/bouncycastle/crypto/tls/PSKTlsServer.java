...
public class PSKTlsServer extends AbstractTlsServer {
    ...
    public TlsKeyExchange createPSKKeyExchange(int i) {
        TlsPSKKeyExchange tlsPSKKeyExchange = new TlsPSKKeyExchange(i, this.supportedSignatureAlgorithms, null, this.pskIdentityManager, null, getDHParameters(), this.namedCurves, this.clientECPointFormats, this.serverECPointFormats);
