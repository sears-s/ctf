...
public class DESEngine implements BlockCipher {
    ...
    private static final short[] bytebit = {DNSKEY.FLAG_REVOKE, 64, 32, 16, 8, 4, 2, 1};
    ...
    public void desFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i21 = 0; i21 < 8; i21++) {
            ...
            int i33 = iArr[i22 + 3] ^ i20;
            i19 ^= ((((iArr5[(i32 >>> 24) & 63] | ((iArr2[i32 & 63] | iArr3[(i32 >>> 8) & 63]) | iArr4[(i32 >>> 16) & 63])) | iArr6[i33 & 63]) | iArr7[(i33 >>> 8) & 63]) | iArr8[(i33 >>> 16) & 63]) | iArr9[(i33 >>> 24) & 63];
        }
        int i34 = (i19 >>> 1) | (i19 << 31);
        int i35 = (i20 ^ i34) & -1431655766;
        int i36 = i20 ^ i35;
        int i37 = i34 ^ i35;
        ...
        int i49 = i46 ^ i48;
        Pack.intToBigEndian(i47 ^ (i48 << 4), bArr3, i3);
        Pack.intToBigEndian(i49, bArr3, i3 + 4);
    }
