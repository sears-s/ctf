...
public final class XMSSPrivateKeyParameters extends XMSSKeyParameters implements XMSSStoreableObjectInterface {
    ...
    private XMSSPrivateKeyParameters(Builder builder) {
        ...
        if (xMSSParameters != null) {
            ...
            if (access$100 == null) {
                ...
                if (access$700 == null) {
                    access$700 = (builder.index >= (1 << this.params.getHeight()) + -2 || access$500 == null || access$300 == null) ? new BDS(this.params, builder.index) : new BDS(this.params, access$500, access$300, (OTSHashAddress) new Builder().build(), builder.index);
                }
    ...
    public XMSSPrivateKeyParameters getNextKey() {
        ...
        if (getIndex() < (1 << this.params.getHeight()) - 1) {
            ...
            bds = this.bdsState.getNextState(this.publicSeed, this.secretKeySeed, (OTSHashAddress) new Builder().build());
        } else {
            withRoot = new Builder(this.params).withSecretKeySeed(this.secretKeySeed).withSecretKeyPRF(this.secretKeyPRF).withPublicSeed(this.publicSeed).withRoot(this.root);
    ...
    public long getUsagesRemaining() {
        return (1 << getParameters().getHeight()) - ((long) getIndex());
    }
