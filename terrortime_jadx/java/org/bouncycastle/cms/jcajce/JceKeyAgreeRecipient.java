...
public abstract class JceKeyAgreeRecipient implements KeyAgreeRecipient {
    ...
    private static KeyMaterialGenerator old_ecc_cms_Generator = new KeyMaterialGenerator() {
        public byte[] generateKDFMaterial(AlgorithmIdentifier algorithmIdentifier, int i, byte[] bArr) {
            try {
                ...
                sb.append("Unable to create KDF material: ");
                sb.append(e);
    ...
    /* JADX WARNING: type inference failed for: r2v2, types: [org.bouncycastle.jcajce.spec.UserKeyingMaterialSpec] */
    /* JADX WARNING: type inference failed for: r2v3, types: [org.bouncycastle.jcajce.spec.UserKeyingMaterialSpec] */
    /* JADX WARNING: type inference failed for: r2v4, types: [org.bouncycastle.jcajce.spec.UserKeyingMaterialSpec] */
    /* JADX WARNING: type inference failed for: r2v5, types: [org.bouncycastle.jcajce.spec.UserKeyingMaterialSpec] */
  ...
  assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], byte[], org.bouncycastle.jcajce.spec.UserKeyingMaterialSpec]
  uses: [java.security.spec.AlgorithmParameterSpec, byte[]]
  mth insns count: 83
    ...
    public java.security.Key extractSecretKey(org.bouncycastle.asn1.x509.AlgorithmIdentifier r9, org.bouncycastle.asn1.x509.AlgorithmIdentifier r10, org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r11, org.bouncycastle.asn1.ASN1OctetString r12, byte[] r13) throws org.bouncycastle.cms.CMSException {
        ...
        L_0x0056:
            ...
            r5 = 4
            org.bouncycastle.jcajce.spec.GOST28147WrapParameterSpec r6 = new org.bouncycastle.jcajce.spec.GOST28147WrapParameterSpec     // Catch:{ InvalidKeyException -> 0x0099, NoSuchAlgorithmException -> 0x00e5, InvalidKeySpecException -> 0x00d3, NoSuchPaddingException -> 0x00ca, Exception -> 0x00c1 }
            ...
            r6.<init>(r3, r7)     // Catch:{ InvalidKeyException -> 0x0099, NoSuchAlgorithmException -> 0x00e5, InvalidKeySpecException -> 0x00d3, NoSuchPaddingException -> 0x00ca, Exception -> 0x00c1 }
            ...
            byte[] r1 = org.bouncycastle.util.Arrays.concatenate(r1, r2)     // Catch:{ InvalidKeyException -> 0x0099, NoSuchAlgorithmException -> 0x00e5, InvalidKeySpecException -> 0x00d3, NoSuchPaddingException -> 0x00ca, Exception -> 0x00c1 }
