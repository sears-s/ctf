...
public class BCFKSLoadStoreParameter extends BCLoadStoreParameter {
    ...
    public static class Builder {
        ...
        /* access modifiers changed from: private */
        public final ProtectionParameter protectionParameter;
        /* access modifiers changed from: private */
        ...
        public Builder(InputStream inputStream, ProtectionParameter protectionParameter2) {
            this.storeConfig = new org.bouncycastle.crypto.util.PBKDF2Config.Builder().withIterationCount(16384).withSaltLength(64).withPRF(PBKDF2Config.PRF_SHA512).build();
        ...
        public Builder(OutputStream outputStream, ProtectionParameter protectionParameter2) {
            this.storeConfig = new org.bouncycastle.crypto.util.PBKDF2Config.Builder().withIterationCount(16384).withSaltLength(64).withPRF(PBKDF2Config.PRF_SHA512).build();
            this.encAlg = EncryptionAlgorithm.AES256_CCM;
            this.macAlg = MacAlgorithm.HmacSHA512;
            this.sigAlg = SignatureAlgorithm.SHA512withECDSA;
