...
public final class RC2 {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        public AlgorithmParameters engineGenerateParameters() {
            ...
            if (this.spec == null) {
                ...
                try {
                    AlgorithmParameters createParametersInstance = createParametersInstance(str);
                ...
                try {
                    AlgorithmParameters createParametersInstance2 = createParametersInstance(str);
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
            ...
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                ...
                if (effectiveKeyBits != -1) {
                    if (effectiveKeyBits < 256) {
                        effectiveKeyBits = table[effectiveKeyBits];
                    }
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            if (cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                int i = this.parameterVersion;
                if (i != -1) {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm(str4, PKCSObjectIdentifiers.id_alg_CMSRC2wrap, "RC2WRAP");
            ...
            String str5 = "PBEWITHMD2ANDRC2";
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory.PBEWITHMD2ANDRC2-CBC", str5);
            String str6 = "PBEWITHMD5ANDRC2";
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory.PBEWITHMD5ANDRC2-CBC", str6);
            String str7 = "PBEWITHSHA1ANDRC2";
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory.PBEWITHSHA1ANDRC2-CBC", str7);
            String str8 = "Alg.Alias.SecretKeyFactory";
            configurableProvider.addAlgorithm(str8, PKCSObjectIdentifiers.pbeWithMD2AndRC2_CBC, str5);
            configurableProvider.addAlgorithm(str8, PKCSObjectIdentifiers.pbeWithMD5AndRC2_CBC, str6);
            configurableProvider.addAlgorithm(str8, PKCSObjectIdentifiers.pbeWithSHA1AndRC2_CBC, str7);
            String str9 = "PBEWITHSHAAND128BITRC2-CBC";
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory.1.2.840.113549.1.12.1.5", str9);
            String str10 = "PBEWITHSHAAND40BITRC2-CBC";
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory.1.2.840.113549.1.12.1.6", str10);
            ...
            configurableProvider.addAlgorithm(str4, PKCSObjectIdentifiers.pbeWithMD2AndRC2_CBC, str5);
            configurableProvider.addAlgorithm(str4, PKCSObjectIdentifiers.pbeWithMD5AndRC2_CBC, str6);
            configurableProvider.addAlgorithm(str4, PKCSObjectIdentifiers.pbeWithSHA1AndRC2_CBC, str7);
            String str11 = "PKCS12PBE";
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.1.2.840.113549.1.12.1.5", str11);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.1.2.840.113549.1.12.1.6", str11);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.PBEWithSHAAnd3KeyTripleDES", str11);
            configurableProvider.addAlgorithm(str4, PKCSObjectIdentifiers.pbeWithSHAAnd128BitRC2_CBC, str9);
            configurableProvider.addAlgorithm(str4, PKCSObjectIdentifiers.pbeWithSHAAnd40BitRC2_CBC, str10);
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.PBEWITHSHA1AND128BITRC2-CBC", str9);
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.PBEWITHSHA1AND40BITRC2-CBC", str10);
            StringBuilder sb17 = new StringBuilder();
            sb17.append(PREFIX);
            sb17.append("$PBEWithSHA1AndRC2");
            configurableProvider.addAlgorithm("Cipher.PBEWITHSHA1ANDRC2", sb17.toString());
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.PBEWITHSHAANDRC2-CBC", str7);
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.PBEWITHSHA1ANDRC2-CBC", str7);
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.PBEWITHMD5ANDRC2-CBC", str6);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.PBEWITHSHA1ANDRC2", str11);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.PBEWITHSHAANDRC2", str11);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.PBEWITHSHA1ANDRC2-CBC", str11);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.PBEWITHSHAAND40BITRC2-CBC", str11);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.PBEWITHSHAAND128BITRC2-CBC", str11);
        }
    }
