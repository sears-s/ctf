    ...
    public static AsymmetricKeyParameter generatePrivateKeyParameter(PrivateKey privateKey) throws InvalidKeyException {
        if (privateKey instanceof ECPrivateKey) {
            ...
            if (eCPrivateKey.getParameters() instanceof ECNamedCurveParameterSpec) {
                String name = ((ECNamedCurveParameterSpec) eCPrivateKey.getParameters()).getName();
                BigInteger d = eCPrivateKey.getD();
                ECNamedDomainParameters eCNamedDomainParameters = new ECNamedDomainParameters(ECNamedCurveTable.getOID(name), parameters.getCurve(), parameters.getG(), parameters.getN(), parameters.getH(), parameters.getSeed());
                return new ECPrivateKeyParameters(d, eCNamedDomainParameters);
            }
            BigInteger d2 = eCPrivateKey.getD();
            ...
            return new ECPrivateKeyParameters(d2, eCDomainParameters);
