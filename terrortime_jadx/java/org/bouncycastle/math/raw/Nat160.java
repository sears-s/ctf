...
public abstract class Nat160 {
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i6 < 5) {
            ...
            int i8 = i5 + 1;
            long j15 = j;
            long j16 = (j14 >>> 32) + (j13 * j9) + (((long) iArr3[i8]) & 4294967295L);
            iArr3[i8] = (int) j16;
            int i9 = i5 + 2;
            long j17 = j3;
            long j18 = (j16 >>> 32) + (j13 * j3) + (((long) iArr3[i9]) & 4294967295L);
            iArr3[i9] = (int) j18;
            int i10 = i5 + 3;
            long j19 = (j18 >>> 32) + (j13 * j4) + (((long) iArr3[i10]) & 4294967295L);
            iArr3[i10] = (int) j19;
            int i11 = i5 + 4;
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 5; i < i2; i2 = 5) {
            ...
            int i4 = i + 1;
            long j15 = j2;
            long j16 = (j14 >>> 32) + (j12 * j2) + (((long) iArr3[i4]) & 4294967295L);
            iArr3[i4] = (int) j16;
            int i5 = i + 2;
            long j17 = j4;
            long j18 = (j16 >>> 32) + (j12 * j5) + (((long) iArr3[i5]) & 4294967295L);
            iArr3[i5] = (int) j18;
            int i6 = i + 3;
            long j19 = (j18 >>> 32) + (j12 * j3) + (((long) iArr3[i6]) & 4294967295L);
            iArr3[i6] = (int) j19;
            int i7 = i + 4;
            long j20 = (j19 >>> 32) + (j12 * j17) + (((long) iArr3[i7]) & 4294967295L);
            iArr3[i7] = (int) j20;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i4 < 5) {
            ...
            int i6 = i5 + 0;
            long j9 = j2;
            long j10 = (j8 * j2) + (((long) iArr3[i6]) & j) + 0;
            iArr3[i6] = (int) j10;
            int i7 = i5 + 1;
            long j11 = j3;
            long j12 = (j10 >>> 32) + (j8 * j3) + (((long) iArr3[i7]) & 4294967295L);
            iArr3[i7] = (int) j12;
            int i8 = i5 + 2;
            long j13 = j4;
            long j14 = (j12 >>> 32) + (j8 * j4) + (((long) iArr3[i8]) & 4294967295L);
            iArr3[i8] = (int) j14;
            int i9 = i5 + 3;
            long j15 = (j14 >>> 32) + (j8 * j5) + (((long) iArr3[i9]) & 4294967295L);
            iArr3[i9] = (int) j15;
            int i10 = i5 + 4;
            long j16 = (j15 >>> 32) + (j8 * j6) + (((long) iArr3[i10]) & 4294967295L);
            iArr3[i10] = (int) j16;
            int i11 = i5 + 5;
            long j17 = (j16 >>> 32) + j7 + (((long) iArr3[i11]) & 4294967295L);
            iArr3[i11] = (int) j17;
            j7 = j17 >>> 32;
            i4++;
            i5 = i7;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                iArr2[9] = (i14 >>> 31) | ((iArr2[9] + ((int) (j38 >>> 32))) << 1);
                return;
            }
            i3 = i4;
            i = i6;
