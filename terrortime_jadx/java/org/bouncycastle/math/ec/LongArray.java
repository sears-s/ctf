    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        while (true) {
            ...
            while (i13 < i4) {
                ...
                int i17 = i13;
                int i18 = i12;
                addBoth(jArr7, i13 - 1, jArr4, iArr3[i15], jArr5, iArr3[i16], i8);
                i13 = i17 + 2;
                i12 = i18;
            }
        ...
        for (int i19 = 56; i19 >= 0; i19 -= 8) {
            int i20 = 0;
            while (i20 < i4) {
                int i21 = (int) (jArr6[i20] >>> i19);
                int i22 = i21 & 15;
                int i23 = (i21 >>> 4) & 15;
                int i24 = i20;
                addBoth(jArr7, i20, jArr4, iArr3[i22], jArr5, iArr3[i23], i8);
                i20 = i24 + 2;
            }
            if (i19 > 0) {
