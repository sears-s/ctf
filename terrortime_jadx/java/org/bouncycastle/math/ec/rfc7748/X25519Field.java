...
public abstract class X25519Field {
    ...
    public static void carry(int[] iArr) {
        ...
        int i16 = i7 + (i12 >> 26);
        int i17 = i12 & M26;
        int i18 = (i3 & M25) + (i15 >> 26);
        int i19 = i15 & M26;
        int i20 = (i5 & M25) + (i11 >> 26);
        int i21 = i11 & M26;
        int i22 = (i8 & M25) + (i16 >> 26);
        int i23 = i16 & M26;
        int i24 = (i10 & M25) + (i13 >> 26);
        int i25 = i13 & M26;
        iArr[0] = i14 & M26;
        iArr[1] = i19;
        iArr[2] = i18;
    ...
    public static void mul(int[] iArr, int i, int[] iArr2) {
        ...
        int i18 = i14;
        long j11 = j7;
        long j12 = j5 + (((long) i18) * j);
        iArr2[5] = ((int) j12) & M26;
        long j13 = j12 >> 26;
        long j14 = j10 + (((long) i13) * j);
        iArr2[1] = ((int) j14) & M26;
        long j15 = j14 >> 26;
        long j16 = j3 + (((long) i11) * j);
        iArr2[3] = ((int) j16) & M26;
        long j17 = j16 >> 26;
        long j18 = j13 + (((long) i8) * j);
        iArr2[6] = ((int) j18) & M26;
        long j19 = j18 >> 26;
        long j20 = j11 + (((long) i10) * j);
        iArr2[8] = ((int) j20) & M26;
        long j21 = j20 >> 26;
        iArr2[2] = i12 + ((int) j15);
        iArr2[4] = i17 + ((int) j17);
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int i47 = i46;
        long j62 = (long) i42;
        long j63 = (j53 * j61) + (j59 * j58) + (j62 * j55);
        long j64 = j58;
        long j65 = (long) i43;
        long j66 = j65;
        long j67 = (long) (i32 + i18);
        long j68 = (((j59 * j61) + (j62 * j58)) << 1) + (j53 * j65) + (j67 * j55);
        long j69 = j61;
        long j70 = (long) i45;
        long j71 = (long) i47;
        long j72 = (((j62 * j70) + (j71 * j69)) << 1) + (j67 * j66);
        long j73 = (j67 * j70) + (j71 * j66);
        long j74 = (j71 * j70) << 1;
        long j75 = j57 + (j68 - j50);
        int i48 = ((int) j75) & M26;
        long j76 = (j75 >> 26) + (((((j62 * j61) << 1) + ((((j53 * j70) + (j59 * j66)) + (j67 * j64)) + (j55 * j71))) - j21) - j45);
        int i49 = ((int) j76) & M25;
        long j77 = j47 + ((((j76 >> 25) + (((((j59 * j70) + (j62 * j66)) + (j67 * j69)) + (j71 * j64)) << 1)) - j54) * 38);
        iArr3[0] = ((int) j77) & M26;
        long j78 = (j77 >> 26) + j48 + ((j72 - j52) * 38);
        iArr3[1] = ((int) j78) & M26;
        long j79 = (j78 >> 26) + j49 + ((j73 - j51) * 38);
        iArr3[2] = ((int) j79) & M25;
        long j80 = (j79 >> 25) + j50 + ((j74 - j57) * 38);
        iArr3[3] = ((int) j80) & M26;
        long j81 = (j80 >> 26) + j21 + (j45 * 38);
        iArr3[4] = ((int) j81) & M25;
        long j82 = (j81 >> 25) + j54 + (j56 - j47);
        iArr3[5] = ((int) j82) & M26;
        long j83 = (j82 >> 26) + j52 + (j60 - j48);
        iArr3[6] = ((int) j83) & M26;
        long j84 = (j83 >> 26) + j51 + (j63 - j49);
        iArr3[7] = ((int) j84) & M25;
        long j85 = (j84 >> 25) + ((long) i48);
        iArr3[8] = ((int) j85) & M26;
        iArr3[9] = i49 + ((int) (j85 >> 26));
    }
