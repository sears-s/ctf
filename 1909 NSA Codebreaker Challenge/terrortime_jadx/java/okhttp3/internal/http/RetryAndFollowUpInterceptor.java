...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r20) throws java.io.IOException {
        ...
        L_0x0030:
            ...
            r5 = 0
            r6 = 0
            okhttp3.Response r0 = r2.proceed(r12, r11, r6, r6)     // Catch:{ RouteException -> 0x013a, IOException -> 0x011d, all -> 0x0119 }
            r14 = 0
        ...
        L_0x0060:
            r15 = r0
        L_0x0061:
            okhttp3.Route r0 = r11.route()     // Catch:{ IOException -> 0x0112 }
            okhttp3.Request r0 = r1.followUpRequest(r15, r0)     // Catch:{ IOException -> 0x0112 }
        ...
        L_0x011d:
            ...
            r2 = r0
            r0 = r2
            boolean r2 = r0 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch:{ all -> 0x015b }
            if (r2 != 0) goto L_0x0128
            r5 = 1
        L_0x0128:
            r2 = r5
            boolean r5 = r1.recover(r0, r11, r2, r12)     // Catch:{ all -> 0x015b }
        ...
        L_0x013a:
            ...
            r2 = r0
            r0 = r2
            java.io.IOException r2 = r0.getLastConnectException()     // Catch:{ all -> 0x015b }
            boolean r2 = r1.recover(r2, r11, r5, r12)     // Catch:{ all -> 0x015b }
        ...
        L_0x0152:
            ...
            goto L_0x0030
        L_0x0156:
            java.io.IOException r2 = r0.getFirstConnectException()     // Catch:{ all -> 0x015b }
    ...
    private Request followUpRequest(Response userResponse, Route route) throws IOException {
        ...
        if (userResponse != null) {
            ...
            if (responseCode == 307 || responseCode == 308) {
                ...
                } else if ((userResponse.priorResponse() == null || userResponse.priorResponse().code() != 503) && retryAfter(userResponse, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) == 0) {
                    return userResponse.request();
                } else {
                    return null;
                }
