...
public class DefaultAlgorithmNameFinder implements AlgorithmNameFinder {
    ...
    static {
        ...
        algorithms.put(OIWObjectIdentifiers.md5WithRSA, str);
        String str2 = "SHA1WITHRSA";
        algorithms.put(OIWObjectIdentifiers.sha1WithRSA, str2);
        ...
        algorithms.put(PKCSObjectIdentifiers.md5, StringUtils.MD5);
        algorithms.put(PKCSObjectIdentifiers.md5WithRSAEncryption, str);
        algorithms.put(PKCSObjectIdentifiers.rsaEncryption, "RSA");
        algorithms.put(PKCSObjectIdentifiers.sha1WithRSAEncryption, str2);
