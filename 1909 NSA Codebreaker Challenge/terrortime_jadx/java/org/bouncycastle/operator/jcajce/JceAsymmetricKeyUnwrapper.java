...
public class JceAsymmetricKeyUnwrapper extends AsymmetricKeyUnwrapper {
    ...
    public org.bouncycastle.operator.GenericKey generateUnwrappedKey(org.bouncycastle.asn1.x509.AlgorithmIdentifier r6, byte[] r7) throws org.bouncycastle.operator.OperatorException {
        /*
            r5 = this;
            org.bouncycastle.operator.jcajce.OperatorHelper r0 = r5.helper     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r1 = r5.getAlgorithmIdentifier()     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r1 = r1.getAlgorithm()     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            java.util.Map r2 = r5.extraMappings     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            javax.crypto.Cipher r0 = r0.createAsymmetricWrapper(r1, r2)     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            org.bouncycastle.operator.jcajce.OperatorHelper r1 = r5.helper     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r2 = r5.getAlgorithmIdentifier()     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            java.security.AlgorithmParameters r1 = r1.createAlgorithmParameters(r2)     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            r2 = 4
            r3 = 0
        ...
        L_0x0059:
            ...
            r1 = 2
            java.security.PrivateKey r2 = r5.privKey     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            r0.init(r1, r2)     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            javax.crypto.spec.SecretKeySpec r3 = new javax.crypto.spec.SecretKeySpec     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            byte[] r7 = r0.doFinal(r7)     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r0 = r6.getAlgorithm()     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            java.lang.String r0 = r0.getId()     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            r3.<init>(r7, r0)     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
        L_0x0072:
            org.bouncycastle.operator.jcajce.JceGenericKey r7 = new org.bouncycastle.operator.jcajce.JceGenericKey     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            r7.<init>(r6, r3)     // Catch:{ InvalidKeyException -> 0x00b0, IllegalBlockSizeException -> 0x0094, BadPaddingException -> 0x0078 }
            return r7
        L_0x0078:
            r6 = move-exception
