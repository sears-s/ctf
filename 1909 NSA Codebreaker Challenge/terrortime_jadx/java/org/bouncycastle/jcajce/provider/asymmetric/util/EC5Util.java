...
public class EC5Util {
    ...
    static {
        ...
        Fp fp = new Fp(curve.getField().getCharacteristic(), curve.getA().toBigInteger(), curve.getB().toBigInteger(), curve.getOrder(), curve.getCofactor());
        map.put(fp, curve);
    }
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        F2m f2m = new F2m(m, convertMidTerms[0], convertMidTerms[1], convertMidTerms[2], a, b);
        return f2m;
    }
    ...
    public static org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec, boolean z) {
        ...
        if (eCParameterSpec instanceof ECNamedCurveSpec) {
            ECNamedCurveParameterSpec eCNamedCurveParameterSpec = new ECNamedCurveParameterSpec(((ECNamedCurveSpec) eCParameterSpec).getName(), convertCurve, convertPoint(convertCurve, eCParameterSpec.getGenerator(), z), eCParameterSpec.getOrder(), BigInteger.valueOf((long) eCParameterSpec.getCofactor()), eCParameterSpec.getCurve().getSeed());
