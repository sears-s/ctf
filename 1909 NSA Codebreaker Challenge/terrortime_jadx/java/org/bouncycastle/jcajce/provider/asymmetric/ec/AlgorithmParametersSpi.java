    ...
    public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
        if (algorithmParameterSpec instanceof ECGenParameterSpec) {
            ...
            if (domainParametersFromGenSpec != null) {
                ...
                ECNamedCurveSpec eCNamedCurveSpec = new ECNamedCurveSpec(this.curveName, convertToSpec.getCurve(), convertToSpec.getGenerator(), convertToSpec.getOrder(), BigInteger.valueOf((long) convertToSpec.getCofactor()));
                this.ecParameterSpec = eCNamedCurveSpec;
                return;
            }
            StringBuilder sb = new StringBuilder();
