...
public class PSSSignatureSpi extends SignatureSpi {
    ...
    public static class SHA3_256withRSA extends PSSSignatureSpi {
        public SHA3_256withRSA() {
            RSABlindedEngine rSABlindedEngine = new RSABlindedEngine();
            PSSParameterSpec pSSParameterSpec = new PSSParameterSpec("SHA3-256", "MGF1", new MGF1ParameterSpec("SHA3-256"), 32, 1);
            super(rSABlindedEngine, pSSParameterSpec);
        }
    }
            ...
            if (pSSParameterSpec2 != null && !DigestFactory.isSameDigest(pSSParameterSpec2.getDigestAlgorithm(), pSSParameterSpec.getDigestAlgorithm())) {
                ...
                if (DigestFactory.isSameDigest(mGF1ParameterSpec.getDigestAlgorithm(), pSSParameterSpec.getDigestAlgorithm())) {
                    ...
                    if (digest != null) {
                        ...
                        setupContentDigest();
                        if (this.key != null) {
                            PSSSigner pSSSigner2 = new PSSSigner(this.signer, this.contentDigest, this.mgfDigest, this.saltLength, this.trailer);
                            this.pss = pSSSigner2;
