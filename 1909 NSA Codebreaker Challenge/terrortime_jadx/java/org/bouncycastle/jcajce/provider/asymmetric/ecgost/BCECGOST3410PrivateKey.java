...
public class BCECGOST3410PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private void populateFromPrivKeyInfo(org.bouncycastle.asn1.pkcs.PrivateKeyInfo r11) throws java.io.IOException {
        ...
        L_0x0097:
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r8 = new org.bouncycastle.asn1.x9.X9ECParameters
    ...
    public byte[] getEncoded() {
        ...
        L_0x00c0:
            ...
            r4.<init>(r0, r5, r3)
        L_0x00c9:
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r0 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch:{ IOException -> 0x00e2 }
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r5 = new org.bouncycastle.asn1.x509.AlgorithmIdentifier     // Catch:{ IOException -> 0x00e2 }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r6 = org.bouncycastle.asn1.cryptopro.CryptoProObjectIdentifiers.gostR3410_2001     // Catch:{ IOException -> 0x00e2 }
            org.bouncycastle.asn1.ASN1Primitive r3 = r3.toASN1Primitive()     // Catch:{ IOException -> 0x00e2 }
            r5.<init>(r6, r3)     // Catch:{ IOException -> 0x00e2 }
            org.bouncycastle.asn1.ASN1Primitive r3 = r4.toASN1Primitive()     // Catch:{ IOException -> 0x00e2 }
            r0.<init>(r5, r3)     // Catch:{ IOException -> 0x00e2 }
            byte[] r0 = r0.getEncoded(r1)     // Catch:{ IOException -> 0x00e2 }
            return r0
        L_0x00e2:
            r0 = move-exception
            return r2
