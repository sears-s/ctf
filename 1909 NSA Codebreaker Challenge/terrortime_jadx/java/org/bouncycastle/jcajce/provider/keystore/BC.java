...
public class BC {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = "BouncyCastle";
            configurableProvider.addAlgorithm("Alg.Alias.KeyStore.UBER", str);
            configurableProvider.addAlgorithm("Alg.Alias.KeyStore.BOUNCYCASTLE", str);
            configurableProvider.addAlgorithm("Alg.Alias.KeyStore.bouncycastle", str);
        }
    }
}
