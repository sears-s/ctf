...
public class MessageDigestUtils {
    ...
    static {
        ...
        String str = "RIPEMD-128";
        digestOidMap.put(TeleTrusTObjectIdentifiers.ripemd128, str);
        String str2 = "RIPEMD-160";
        digestOidMap.put(TeleTrusTObjectIdentifiers.ripemd160, str2);
        digestOidMap.put(TeleTrusTObjectIdentifiers.ripemd256, str);
        digestOidMap.put(ISOIECObjectIdentifiers.ripemd128, str);
        digestOidMap.put(ISOIECObjectIdentifiers.ripemd160, str2);
