...
public class LDAPStoreHelper {
  ...
  PHI: (r4v5 int) = (r4v1 int), (r4v6 int) binds: [B:25:0x009a, B:28:0x009f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private List cRLIssuerSearch(X509CRLStoreSelector x509CRLStoreSelector, String[] strArr, String[] strArr2, String[] strArr3) throws StoreException {
        ...
        while (true) {
            ...
            for (String parseDN : strArr3) {
                String parseDN2 = parseDN(str2, parseDN);
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<byte[]>, for r5v0, types: [java.util.List<byte[]>, java.util.List] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.Set createAttributeCertificates(java.util.List<byte[]> r5, org.bouncycastle.x509.X509AttributeCertStoreSelector r6) throws org.bouncycastle.util.StoreException {
        /*
            r4 = this;
        ...
        L_0x000e:
            ...
            java.io.ByteArrayInputStream r2 = new java.io.ByteArrayInputStream     // Catch:{ StreamParsingException -> 0x0034 }
            java.lang.Object r3 = r5.next()     // Catch:{ StreamParsingException -> 0x0034 }
            byte[] r3 = (byte[]) r3     // Catch:{ StreamParsingException -> 0x0034 }
            byte[] r3 = (byte[]) r3     // Catch:{ StreamParsingException -> 0x0034 }
            r2.<init>(r3)     // Catch:{ StreamParsingException -> 0x0034 }
            r1.engineInit(r2)     // Catch:{ StreamParsingException -> 0x0034 }
            java.lang.Object r2 = r1.engineRead()     // Catch:{ StreamParsingException -> 0x0034 }
            org.bouncycastle.x509.X509AttributeCertificate r2 = (org.bouncycastle.x509.X509AttributeCertificate) r2     // Catch:{ StreamParsingException -> 0x0034 }
            boolean r3 = r6.match(r2)     // Catch:{ StreamParsingException -> 0x0034 }
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<byte[]>, for r5v0, types: [java.util.List<byte[]>, java.util.List] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.Set createCRLs(java.util.List<byte[]> r5, org.bouncycastle.x509.X509CRLStoreSelector r6) throws org.bouncycastle.util.StoreException {
        /*
            r4 = this;
            java.util.HashSet r0 = new java.util.HashSet
            r0.<init>()
        ...
        L_0x000e:
            ...
            r1.engineInit(r2)     // Catch:{ StreamParsingException -> 0x0034 }
            java.lang.Object r2 = r1.engineRead()     // Catch:{ StreamParsingException -> 0x0034 }
            java.security.cert.X509CRL r2 = (java.security.cert.X509CRL) r2     // Catch:{ StreamParsingException -> 0x0034 }
            boolean r3 = r6.match(r2)     // Catch:{ StreamParsingException -> 0x0034 }
            if (r3 == 0) goto L_0x000e
            r0.add(r2)     // Catch:{ StreamParsingException -> 0x0034 }
            goto L_0x000e
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<byte[]>, for r5v0, types: [java.util.List<byte[]>, java.util.List] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.Set createCerts(java.util.List<byte[]> r5, org.bouncycastle.x509.X509CertStoreSelector r6) throws org.bouncycastle.util.StoreException {
        /*
            r4 = this;
            java.util.HashSet r0 = new java.util.HashSet
            r0.<init>()
        ...
        L_0x000e:
            boolean r2 = r5.hasNext()
            if (r2 == 0) goto L_0x0036
            java.io.ByteArrayInputStream r2 = new java.io.ByteArrayInputStream     // Catch:{ Exception -> 0x0034 }
            java.lang.Object r3 = r5.next()     // Catch:{ Exception -> 0x0034 }
            byte[] r3 = (byte[]) r3     // Catch:{ Exception -> 0x0034 }
            byte[] r3 = (byte[]) r3     // Catch:{ Exception -> 0x0034 }
            r2.<init>(r3)     // Catch:{ Exception -> 0x0034 }
            r1.engineInit(r2)     // Catch:{ Exception -> 0x0034 }
            java.lang.Object r2 = r1.engineRead()     // Catch:{ Exception -> 0x0034 }
            java.security.cert.X509Certificate r2 = (java.security.cert.X509Certificate) r2     // Catch:{ Exception -> 0x0034 }
            boolean r3 = r6.match(r2)     // Catch:{ Exception -> 0x0034 }
            if (r3 == 0) goto L_0x000e
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:?, code lost:
        r3.close();
     */
    /* JADX WARNING: Incorrect condition in loop: B:25:0x00d0 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.List search(java.lang.String[] r10, java.lang.String r11, java.lang.String[] r12) throws org.bouncycastle.util.StoreException {
        ...
        L_0x00a8:
            ...
            r10.<init>()
            javax.naming.directory.DirContext r3 = r9.connectLDAP()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            javax.naming.directory.SearchControls r0 = new javax.naming.directory.SearchControls     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            r0.<init>()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            r1 = 2
            r0.setSearchScope(r1)     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            r1 = 0
            r0.setCountLimit(r1)     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            r0.setReturningAttributes(r12)     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            org.bouncycastle.jce.X509LDAPCertStoreParameters r12 = r9.params     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            java.lang.String r12 = r12.getBaseDN()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            javax.naming.NamingEnumeration r12 = r3.search(r12, r11, r0)     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
        L_0x00cc:
            boolean r0 = r12.hasMoreElements()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            if (r0 == 0) goto L_0x00f8
            java.lang.Object r0 = r12.next()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            javax.naming.directory.SearchResult r0 = (javax.naming.directory.SearchResult) r0     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            javax.naming.directory.Attributes r0 = r0.getAttributes()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            javax.naming.NamingEnumeration r0 = r0.getAll()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            java.lang.Object r0 = r0.next()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            javax.naming.directory.Attribute r0 = (javax.naming.directory.Attribute) r0     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            javax.naming.NamingEnumeration r0 = r0.getAll()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
        L_0x00ea:
            boolean r1 = r0.hasMore()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            if (r1 == 0) goto L_0x00cc
            java.lang.Object r1 = r0.next()     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            r10.add(r1)     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
            goto L_0x00ea
        L_0x00f8:
            r9.addToCache(r11, r10)     // Catch:{ NamingException -> 0x010c, all -> 0x0103 }
