...
public class X509CertificatePair {
    ...
    public boolean equals(Object obj) {
        ...
        boolean z2 = x509Certificate != null ? x509Certificate.equals(x509CertificatePair.forward) : x509CertificatePair.forward == null;
        X509Certificate x509Certificate2 = this.reverse;
        X509Certificate x509Certificate3 = x509CertificatePair.reverse;
        boolean z3 = x509Certificate2 != null ? x509Certificate2.equals(x509Certificate3) : x509Certificate3 == null;
        if (z2 && z3) {
            z = true;
        }
        return z;
