...
public final class GoppaCode {
    ...
    public static GF2Matrix createCanonicalCheckMatrix(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        int[][] iArr = (int[][]) Array.newInstance(cls, new int[]{degree2, i});
        int[][] iArr2 = (int[][]) Array.newInstance(cls, new int[]{degree2, i});
        int i2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
            iArr2[0][i3] = gF2mField2.inverse(polynomialGF2mSmallM2.evaluateAt(i3));
        }
        for (int i4 = 1; i4 < degree2; i4++) {
            for (int i5 = 0; i5 < i; i5++) {
                iArr2[i4][i5] = gF2mField2.mult(iArr2[i4 - 1][i5], i5);
            }
        }
        int i6 = 0;
        while (i6 < degree2) {
            ...
            while (i7 < i) {
                for (int i8 = i2; i8 <= i6; i8++) {
                    iArr[i6][i7] = gF2mField2.add(iArr[i6][i7], gF2mField2.mult(iArr2[i8][i7], polynomialGF2mSmallM2.getCoefficient((degree2 + i8) - i6)));
                }
                i7++;
                i2 = 0;
            }
        ...
        int[][] iArr3 = (int[][]) Array.newInstance(cls, new int[]{degree2 * degree, (i + 31) >>> 5});
