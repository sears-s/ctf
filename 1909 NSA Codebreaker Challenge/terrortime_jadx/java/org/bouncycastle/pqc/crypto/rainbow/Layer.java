...
public class Layer {
    ...
    public Layer(int i, int i2, SecureRandom secureRandom) {
        ...
        this.oi = i2 - i;
        int i3 = this.oi;
        this.coeff_alpha = (short[][][]) Array.newInstance(cls, new int[]{i3, i3, this.vi});
        int i4 = this.oi;
        int i5 = this.vi;
        this.coeff_beta = (short[][][]) Array.newInstance(cls, new int[]{i4, i5, i5});
        this.coeff_gamma = (short[][]) Array.newInstance(cls, new int[]{this.oi, this.viNext});
        int i6 = this.oi;
