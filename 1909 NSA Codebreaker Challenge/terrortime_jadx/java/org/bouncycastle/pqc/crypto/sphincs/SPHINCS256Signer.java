...
public class SPHINCS256Signer implements MessageSigner {
    ...
    static void compute_authpath_wots(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, int i, leafaddr leafaddr, byte[] bArr3, byte[] bArr4, int i2) {
    ...
    public byte[] crypto_sign(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2) {
        ...
        for (int i7 = 12; i6 < i7; i7 = 12) {
            ...
            int i8 = i5;
            byte[] bArr25 = bArr18;
            wots.wots_sign(hashFunctions2, bArr23, i5, bArr16, bArr20, bArr25);
            int i9 = i8 + 2144;
            byte[] bArr26 = bArr18;
            compute_authpath_wots(hashFunctions2, bArr16, bArr23, i9, leafaddr2, bArr24, bArr25, 5);
            i5 = i9 + CipherSuite.TLS_DH_RSA_WITH_AES_128_GCM_SHA256;
    ...
    public boolean verify(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        if (bArr5.length == 41000) {
            ...
            while (i5 < 12) {
                ...
                byte[] bArr15 = bArr8;
                byte[] bArr16 = bArr7;
                validate_authpath(hashFunctions2, bArr8, bArr7, (int) (j2 & 31), bArr14, i7, bArr13, 5);
                j2 >>= 5;
                i4 = i7 + CipherSuite.TLS_DH_RSA_WITH_AES_128_GCM_SHA256;
                i5++;
                bArr9 = bArr14;
                bArr10 = bArr13;
            }
