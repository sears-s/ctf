...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            bArr[i4] = (byte[][]) Array.newInstance(cls, new int[]{this.heightOfTrees[i4], this.mdLength});
            int[] iArr = this.heightOfTrees;
            treehashArr[i4] = new Treehash[(iArr[i4] - this.K[i4])];
            if (i4 > 0) {
                int i5 = i4 - 1;
                bArr2[i5] = (byte[][]) Array.newInstance(cls, new int[]{iArr[i4], this.mdLength});
        ...
        byte[][] bArr3 = (byte[][]) Array.newInstance(cls, new int[]{i, this.mdLength});
        byte[][] bArr4 = (byte[][]) Array.newInstance(cls, new int[]{this.numLayer - 1, this.mdLength});
        byte[][] bArr5 = (byte[][]) Array.newInstance(cls, new int[]{this.numLayer, this.mdLength});
        int i6 = 0;
        while (true) {
            i2 = this.numLayer;
            if (i6 >= i2) {
        ...
        byte[][] bArr7 = bArr4;
        this.currentRootSigs = (byte[][]) Array.newInstance(cls, new int[]{i2 - 1, this.mdLength});
        ...
        while (i9 >= 0) {
            ...
            treehashArr4[i9] = generateNextAuthpathAndRoot.getTreehash();
        ...
        GMSSPrivateKeyParameters gMSSPrivateKeyParameters = new GMSSPrivateKeyParameters(this.currentSeeds, this.nextNextSeeds, bArr, bArr2, treehashArr, treehashArr4, vectorArr7, vectorArr2, vectorArr10, vectorArr4, bArr7, this.currentRootSigs, this.gmssPS, this.digestProvider);
    ...
    public void initialize(KeyGenerationParameters keyGenerationParameters) {
        ...
        this.currentSeeds = (byte[][]) Array.newInstance(cls, new int[]{this.numLayer, this.mdLength});
        this.nextNextSeeds = (byte[][]) Array.newInstance(cls, new int[]{this.numLayer - 1, this.mdLength});
