...
class Pack {
    ...
    public static void decodePublicKeyIIIP(int[] iArr, byte[] bArr, int i, byte[] bArr2) {
        ...
        for (int i3 = 0; i3 < 10240; i3 += 32) {
            iArr[i3] = CommonFunction.load32(bArr2, i2 * 4) & ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            for (int i4 = 1; i4 < 31; i4++) {
                int i5 = i2 + i4;
                iArr[i3 + i4] = ((CommonFunction.load32(bArr2, i5 * 4) << i4) | (CommonFunction.load32(bArr2, (i5 - 1) * 4) >>> (32 - i4))) & ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            }
            i2 += 31;
    ...
    public static void encodePublicKeyIP(byte[] bArr, long[] jArr, byte[] bArr2, int i) {
        ...
        for (int i3 = 0; i3 < 3712; i3 += 29) {
            ...
            int i13 = i2 + 11;
            CommonFunction.store32(bArr3, (i3 + 9) * 4, (int) (j | (jArr[i13] << 31)));
            int i14 = i2 + 12;
