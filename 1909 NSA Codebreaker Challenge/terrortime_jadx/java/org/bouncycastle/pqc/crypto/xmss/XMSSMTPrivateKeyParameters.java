        ...
        if (xMSSMTParameters != null) {
            ...
            if (access$100 == null) {
                ...
                if (XMSSUtil.isIndexValid(height, this.index)) {
                    ...
                    try {
                        this.bdsState = ((BDSStateMap) XMSSUtil.deserialize(XMSSUtil.extractBytesAtOffset(access$100, i6, access$100.length - i6), BDSStateMap.class)).withWOTSDigest(DigestUtil.getDigestOID(builder.xmss.getDigest().getAlgorithmName()));
                    } catch (IOException e) {
