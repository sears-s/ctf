...
public interface RosstandartObjectIdentifiers {
    ...
    static {
        String str = "1";
        id_tc26 = rosstandart.branch(str);
        id_tc26_agreement_gost_3410_12_256 = id_tc26_agreement.branch(str);
        String str2 = "2";
        id_tc26_agreement_gost_3410_12_512 = id_tc26_agreement.branch(str2);
        id_tc26_gost_3410_12_256_paramSetA = id_tc26_gost_3410_12_256_paramSet.branch(str);
        id_tc26_gost_3410_12_512_paramSetA = id_tc26_gost_3410_12_512_paramSet.branch(str);
        id_tc26_gost_3410_12_512_paramSetB = id_tc26_gost_3410_12_512_paramSet.branch(str2);
    }
}
