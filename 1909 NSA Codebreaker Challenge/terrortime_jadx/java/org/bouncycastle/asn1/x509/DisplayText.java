...
public class DisplayText extends ASN1Object implements ASN1Choice {
    ...
    public DisplayText(int i, String str) {
        ...
        this.contentType = i;
        ASN1String dERIA5String = i != 0 ? i != 1 ? i != 2 ? i != 3 ? new DERUTF8String(str) : new DERVisibleString(str) : new DERUTF8String(str) : new DERBMPString(str) : new DERIA5String(str);
