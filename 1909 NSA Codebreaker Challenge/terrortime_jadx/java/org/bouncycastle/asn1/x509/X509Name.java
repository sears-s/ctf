...
public class X509Name extends ASN1Object {
    ...
    static {
        ...
        String str2 = "O";
        DefaultSymbols.put(O, str2);
        DefaultSymbols.put(T, "T");
        String str3 = "OU";
        DefaultSymbols.put(OU, str3);
        String str4 = "CN";
        DefaultSymbols.put(CN, str4);
        String str5 = "L";
        DefaultSymbols.put(L, str5);
        String str6 = "ST";
        DefaultSymbols.put(ST, str6);
        DefaultSymbols.put(SN, "SERIALNUMBER");
        DefaultSymbols.put(EmailAddress, "E");
        String str7 = "DC";
        DefaultSymbols.put(DC, str7);
        String str8 = "UID";
        ...
        RFC2253Symbols.put(C, str);
        RFC2253Symbols.put(O, str2);
        RFC2253Symbols.put(OU, str3);
        RFC2253Symbols.put(CN, str4);
        RFC2253Symbols.put(L, str5);
        RFC2253Symbols.put(ST, str6);
        RFC2253Symbols.put(STREET, str9);
        RFC2253Symbols.put(DC, str7);
        RFC2253Symbols.put(UID, str8);
        RFC1779Symbols.put(C, str);
        RFC1779Symbols.put(O, str2);
        RFC1779Symbols.put(OU, str3);
        RFC1779Symbols.put(CN, str4);
        RFC1779Symbols.put(L, str5);
        RFC1779Symbols.put(ST, str6);
    ...
    private void appendValue(StringBuffer stringBuffer, Hashtable hashtable, ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        if (str3 == null) {
            str3 = aSN1ObjectIdentifier.getId();
        }
