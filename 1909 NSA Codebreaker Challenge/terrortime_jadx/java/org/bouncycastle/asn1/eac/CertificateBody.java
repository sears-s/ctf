            ...
            while (true) {
                ...
                if (readObject == null) {
                    ...
                    if (applicationTag == 2) {
                        ...
                        StringBuilder sb = new StringBuilder();
                        sb.append("Not a valid iso7816 ASN1ApplicationSpecific tag ");
                        sb.append(aSN1ApplicationSpecific2.getApplicationTag());
                        throw new IOException(sb.toString());
                    }
                } else {
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append("Not a valid iso7816 content : not a ASN1ApplicationSpecific Object :");
