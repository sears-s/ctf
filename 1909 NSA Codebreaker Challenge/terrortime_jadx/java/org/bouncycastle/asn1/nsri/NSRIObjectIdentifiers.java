...
public interface NSRIObjectIdentifiers {
    ...
    static {
        String str = "1";
        id_algorithm = nsri.branch(str);
        id_sea = id_algorithm.branch(str);
        String str2 = "2";
        id_pad = id_algorithm.branch(str2);
        id_pad_1 = id_algorithm.branch(str);
        id_aria128_ecb = id_sea.branch(str);
        id_aria128_cbc = id_sea.branch(str2);
    }
}
