...
public interface CRMFObjectIdentifiers {
    ...
    static {
        ...
        String str2 = "3";
        id_regCtrl_pkiPublicationInfo = id_regCtrl.branch(str2);
        String str3 = "4";
        id_regCtrl_pkiArchiveOptions = id_regCtrl.branch(str3);
        id_dh_sig_hmac_sha1 = id_alg.branch(str2);
        id_alg_dh_pop = id_alg.branch(str3);
    }
}
