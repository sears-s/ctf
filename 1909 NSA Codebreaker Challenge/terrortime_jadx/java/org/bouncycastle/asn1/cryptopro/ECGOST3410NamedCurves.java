...
public class ECGOST3410NamedCurves {
    ...
    static {
        ...
        String str4 = "166";
        Fp fp = new Fp(bigInteger, new BigInteger(str3), new BigInteger(str4), bigInteger2, ECConstants.ONE);
        String str5 = "1";
        String str6 = "64033881142927202683649881450433473985931760268884941288852745803908878638612";
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_A, new ECDomainParameters(fp, fp.createPoint(new BigInteger(str5), new BigInteger(str6)), bigInteger2, ECConstants.ONE));
        BigInteger bigInteger3 = new BigInteger(str);
        BigInteger bigInteger4 = new BigInteger(str2);
        Fp fp2 = new Fp(bigInteger3, new BigInteger(str3), new BigInteger(str4), bigInteger4, ECConstants.ONE);
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_XchA, new ECDomainParameters(fp2, fp2.createPoint(new BigInteger(str5), new BigInteger(str6)), bigInteger4, ECConstants.ONE));
        ...
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_B, new ECDomainParameters(fp3, fp3.createPoint(new BigInteger(str5), new BigInteger("28792665814854611296992347458380284135028636778229113005756334730996303888124")), bigInteger6, ECConstants.ONE));
        ...
        String str10 = "32858";
        Fp fp4 = new Fp(bigInteger7, new BigInteger(str9), new BigInteger(str10), bigInteger8, ECConstants.ONE);
        String str11 = "0";
        String str12 = "29818893917731240733471273240314769927240550812383695689146495261604565990247";
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_XchB, new ECDomainParameters(fp4, fp4.createPoint(new BigInteger(str11), new BigInteger(str12)), bigInteger8, ECConstants.ONE));
        BigInteger bigInteger9 = new BigInteger(str7);
        BigInteger bigInteger10 = new BigInteger(str8);
        Fp fp5 = new Fp(bigInteger9, new BigInteger(str9), new BigInteger(str10), bigInteger10, ECConstants.ONE);
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_C, new ECDomainParameters(fp5, fp5.createPoint(new BigInteger(str11), new BigInteger(str12)), bigInteger10, ECConstants.ONE));
        ...
        Fp fp6 = new Fp(bigInteger11, new BigInteger("C2173F1513981673AF4892C23035A27CE25E2013BF95AA33B22C656F277E7335", 16), new BigInteger("295F9BAE7428ED9CCC20E7C359A9D41A22FCCD9108E17BF7BA9337A6F8AE9513", 16), bigInteger12, ECConstants.FOUR);
        ...
        String str13 = "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFDC7";
        BigInteger bigInteger13 = new BigInteger(str13, 16);
        ...
        BigInteger bigInteger17 = new BigInteger(str13, 16);
        ...
        String str14 = "GostR3410-2001-CryptoPro-A";
        objIds.put(str14, CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_A);
        ...
        names.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_A, str14);
