...
public class TimeStampRequestGenerator {
    ...
    public TimeStampRequest generate(String str, byte[] bArr, BigInteger bigInteger) {
        ...
        if (str != null) {
            ...
            if (bigInteger != null) {
                timeStampReq = new TimeStampReq(messageImprint, aSN1ObjectIdentifier, new ASN1Integer(bigInteger), this.certReq, extensions2);
                timeStampRequest = new TimeStampRequest(timeStampReq);
                return timeStampRequest;
            }
            new TimeStampReq(messageImprint, aSN1ObjectIdentifier, null, this.certReq, extensions2);
            timeStampRequest = new TimeStampRequest(timeStampReq);
            return timeStampRequest;
        }
