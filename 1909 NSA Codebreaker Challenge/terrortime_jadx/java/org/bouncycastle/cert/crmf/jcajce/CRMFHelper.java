...
class CRMFHelper {
    ...
    static {
        ...
        String str = "AES";
        BASE_CIPHER_NAMES.put(NISTObjectIdentifiers.id_aes128_CBC, str);
        BASE_CIPHER_NAMES.put(NISTObjectIdentifiers.id_aes192_CBC, str);
        BASE_CIPHER_NAMES.put(NISTObjectIdentifiers.id_aes256_CBC, str);
        CIPHER_ALG_NAMES.put(CMSAlgorithm.DES_EDE3_CBC, "DESEDE/CBC/PKCS5Padding");
        String str2 = "AES/CBC/PKCS5Padding";
        CIPHER_ALG_NAMES.put(CMSAlgorithm.AES128_CBC, str2);
        CIPHER_ALG_NAMES.put(CMSAlgorithm.AES192_CBC, str2);
        CIPHER_ALG_NAMES.put(CMSAlgorithm.AES256_CBC, str2);
        ...
        MAC_ALG_NAMES.put(IANAObjectIdentifiers.hmacSHA1, str3);
        MAC_ALG_NAMES.put(PKCSObjectIdentifiers.id_hmacWithSHA1, str3);
    ...
    public AlgorithmIdentifier getAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmParameters algorithmParameters) throws CRMFException {
        ...
        if (algorithmParameters != null) {
            try {
                ...
                StringBuilder sb = new StringBuilder();
                sb.append("cannot encode parameters: ");
