...
public class PSKTlsClient extends AbstractTlsClient {
    ...
    public TlsKeyExchange createPSKKeyExchange(int i) {
        TlsPSKKeyExchange tlsPSKKeyExchange = new TlsPSKKeyExchange(i, this.supportedSignatureAlgorithms, this.pskIdentity, null, this.dhVerifier, null, this.namedCurves, this.clientECPointFormats, this.serverECPointFormats);
