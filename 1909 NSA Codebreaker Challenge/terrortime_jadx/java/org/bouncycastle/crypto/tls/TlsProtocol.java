...
public abstract class TlsProtocol {
        ...
        try {
            ...
            if (this.tlsSession != null) {
                if (this.sessionParameters == null) {
                    this.sessionParameters = new Builder().setCipherSuite(this.securityParameters.getCipherSuite()).setCompressionAlgorithm(this.securityParameters.getCompressionAlgorithm()).setExtendedMasterSecret(this.securityParameters.isExtendedMasterSecret()).setMasterSecret(this.securityParameters.getMasterSecret()).setPeerCertificate(this.peerCertificate).setPSKIdentity(this.securityParameters.getPSKIdentity()).setSRPIdentity(this.securityParameters.getSRPIdentity()).setServerExtensions(this.serverExtensions).build();
    ...
    public void safeCheckRecordHeader(byte[] bArr) throws IOException {
        ...
        try {
            ...
            handleException(e.getAlertDescription(), str, e);
            throw e;
        } catch (IOException e2) {
            handleException(80, str, e2);
            throw e2;
        } catch (RuntimeException e3) {
            handleException(80, str, e3);
    ...
    public void sendCertificateMessage(Certificate certificate) throws IOException {
        ...
        if (certificate.isEmpty() && !getContext().isServer()) {
            ...
            if (serverVersion.isSSL()) {
                ...
                raiseAlertWarning(41, sb.toString());
                return;
            }
        }
