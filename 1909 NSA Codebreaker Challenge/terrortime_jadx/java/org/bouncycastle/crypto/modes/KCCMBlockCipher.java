...
public class KCCMBlockCipher implements AEADBlockCipher {
    ...
    public int processPacket(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IllegalStateException, InvalidCipherTextException {
        ...
        if (bArr.length - i < i2) {
            ...
            String str = "partial blocks not supported";
            if (this.forEncryption) {
                if (i2 % this.engine.getBlockSize() == 0) {
                    ...
                    while (true) {
                        ...
                        if (i9 < i10) {
                            bArr2[i5 + i9] = (byte) (this.buffer[i9] ^ this.macBlock[i9]);
                            i9++;
                        } else {
                            System.arraycopy(this.macBlock, 0, this.mac, 0, i10);
                            reset();
                ...
                for (int i13 = 0; i13 < blockSize; i13++) {
                    ProcessBlock(bArr, i12, i2, bArr2, i11);
                ...
                if (i2 > i12) {
                    ...
                    while (true) {
                        ...
                        bArr2[i11 + i15] = (byte) (this.buffer[i15] ^ bArr[i12 + i15]);
                        i15++;
                    }
                    i11 += i4;
                }
                ...
                while (true) {
                    ...
                    byte[] bArr8 = this.s;
                    bArr8[i16] = (byte) (bArr8[i16] + bArr7[i16]);
                    i16++;
                }
                this.engine.processBlock(this.s, 0, this.buffer, 0);
                ...
                System.arraycopy(this.buffer, 0, bArr9, 0, i18);
