...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    public void processBlock() {
        ...
        while (i2 < 10) {
            long j19 = j18;
            int i4 = i3 + 1;
            long Sum1 = j10 + Sum1(j18) + Ch(j18, j12, j11) + K[i3] + this.W[i3];
            long j20 = j15;
            long j21 = j16 + Sum1;
            ...
            long j23 = Sum0;
            int i5 = i4 + 1;
            long Sum12 = j11 + Sum1(j21) + Ch(j21, j19, j12) + K[i4] + this.W[i4];
            int i6 = i2;
            long j24 = j23;
            long j25 = j17 + Sum12;
            int i7 = i5 + 1;
            long Sum13 = j12 + Sum1(j25) + Ch(j25, j22, j19) + K[i5] + this.W[i5];
            long j26 = j13 + Sum13;
            ...
            long j29 = Sum03;
            int i8 = i7 + 1;
            long Sum14 = j19 + Sum1(j26) + Ch(j26, j25, j22) + K[i7] + this.W[i7];
            long j30 = j29;
            long j31 = j20 + Sum14;
            long j32 = j31;
            long Sum04 = Sum14 + Sum0(j29) + Maj(j29, j27, j24);
            int i9 = i8 + 1;
            long Sum15 = j22 + Sum1(j31) + Ch(j31, j28, j25) + K[i8] + this.W[i8];
            long j33 = j24 + Sum15;
            ...
            int i10 = i9 + 1;
            long Sum16 = j25 + Sum1(j35) + Ch(j35, j32, j28) + K[i9] + this.W[i9];
            long j36 = j27 + Sum16;
            long j37 = Maj;
            long j38 = j36;
            long Sum06 = Sum16 + Sum0(Maj) + Maj(Maj, j34, j30);
            int i11 = i10 + 1;
            long Sum17 = j28 + Sum1(j38) + Ch(j38, j35, j32) + K[i10] + this.W[i10];
            long j39 = j30 + Sum17;
            ...
            j12 = j41;
            long j42 = Maj2;
            long Ch = j32 + Sum18 + Ch(j41, j38, j35) + K[i11] + this.W[i11];
