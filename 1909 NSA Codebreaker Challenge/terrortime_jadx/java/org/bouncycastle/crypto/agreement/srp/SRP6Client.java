    ...
    public BigInteger calculateClientEvidenceMessage() throws CryptoException {
        ...
        if (bigInteger != null) {
            ...
            if (bigInteger2 != null) {
                ...
                if (bigInteger3 != null) {
                    this.M1 = SRP6Util.calculateM1(this.digest, this.N, bigInteger, bigInteger2, bigInteger3);
                    return this.M1;
                }
            }
        }
    ...
    public boolean verifyServerEvidenceMessage(BigInteger bigInteger) throws CryptoException {
        ...
        if (bigInteger2 != null) {
            ...
            if (bigInteger3 != null) {
                ...
                if (bigInteger4 != null) {
                    if (!SRP6Util.calculateM2(this.digest, this.N, bigInteger2, bigInteger3, bigInteger4).equals(bigInteger)) {
                        return false;
                    }
                    this.M2 = bigInteger;
                    return true;
