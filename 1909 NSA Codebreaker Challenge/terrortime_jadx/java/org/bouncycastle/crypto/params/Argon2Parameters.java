...
public class Argon2Parameters {
    ...
    public static class Builder {
        ...
        public Argon2Parameters build() {
            Argon2Parameters argon2Parameters = new Argon2Parameters(this.type, this.salt, this.secret, this.additional, this.iterations, this.memory, this.lanes, this.version, this.converter);
