...
public class Poly1305 implements Mac {
    ...
    public int doFinal(byte[] bArr, int i) throws DataLengthException, IllegalStateException {
        if (i + 16 <= bArr.length) {
            ...
            int i27 = i24 + i26;
            int i28 = i27 >>> 26;
            int i29 = 67108863 & i27;
            int i30 = this.h4;
            int i31 = (i28 + i30) - 67108864;
            int i32 = (i31 >>> 31) - 1;
            int i33 = ~i32;
            this.h0 = (i14 & i33) | (i17 & i32);
            this.h1 = (i18 & i33) | (i21 & i32);
            this.h2 = (i22 & i33) | (i25 & i32);
            this.h3 = (i29 & i32) | (i26 & i33);
            this.h4 = (i30 & i33) | (i31 & i32);
            int i34 = this.h0;
            int i35 = this.h1;
            long j = (((long) (i34 | (i35 << 26))) & BodyPartID.bodyIdMax) + (((long) this.k0) & BodyPartID.bodyIdMax);
            int i36 = i35 >>> 6;
            int i37 = this.h2;
            long j2 = (((long) (i36 | (i37 << 20))) & BodyPartID.bodyIdMax) + (((long) this.k1) & BodyPartID.bodyIdMax);
            int i38 = i37 >>> 12;
            int i39 = this.h3;
            long j3 = (((long) (i38 | (i39 << 14))) & BodyPartID.bodyIdMax) + (((long) this.k2) & BodyPartID.bodyIdMax);
            long j4 = (((long) ((i39 >>> 18) | (this.h4 << 8))) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) this.k3));
