...
public class RijndaelEngine implements BlockCipher {
    ...
    private void InvMixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            j4 = (((long) ((((mul0xe(b) ^ mul0xb(b2)) ^ mul0xd(b3)) ^ mul0x9(b4)) & 255)) << i) | j5;
        }
        long j6 = j4;
        this.A0 = j;
        this.A1 = j2;
    ...
    private void MixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            j4 = (((long) ((((mul0x2(i5) ^ mul0x3(i2)) ^ i3) ^ i4) & 255)) << i) | j5;
        }
        long j6 = j4;
        this.A0 = j;
        this.A1 = j2;
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        while (true) {
            i2 = 1;
            if (i9 >= i || i10 >= (this.ROUNDS + 1) * (this.BC / 8)) {
                byte[][] bArr4 = bArr3;
                int i11 = 0;
            } else {
                int i12 = 0;
                while (i12 < i4) {
                    int i13 = this.BC;
                    long[] jArr2 = jArr[i10 / (i13 / 8)];
                    byte[][] bArr5 = bArr3;
                    jArr2[i12] = (((long) (bArr3[i12][i9] & 255)) << ((i10 * 8) % i13)) | jArr2[i12];
                    i12++;
                    bArr3 = bArr5;
                    i4 = 4;
                }
        ...
        byte[][] bArr42 = bArr3;
        int i112 = 0;
        while (i10 < (this.ROUNDS + i2) * (this.BC / 8)) {
            int i14 = i5;
            while (i14 < 4) {
                byte[] bArr7 = bArr42[i14];
                i14++;
                bArr7[i5] = (byte) (bArr7[i5] ^ S[bArr42[i14 % 4][i - 1] & 255]);
            }
            byte[] bArr8 = bArr42[i5];
            int i15 = i112 + 1;
            bArr8[i5] = (byte) (rcon[i112] ^ bArr8[i5]);
            int i16 = i2;
            if (i <= 6) {
                while (i16 < i) {
                ...
                while (true) {
                    ...
                    while (i18 < i3) {
                        ...
                        bArr10[i16] = (byte) (bArr10[i16] ^ bArr42[i18][i16 - 1]);
                        i18++;
                        i3 = 4;
                    }
                    i16++;
                ...
                for (int i19 = i5; i19 < 4; i19++) {
                    ...
                    bArr11[4] = (byte) (bArr11[4] ^ S[bArr42[i19][3] & 255]);
                }
                int i20 = 5;
                while (i20 < i) {
                    int i21 = i5;
            ...
            int i22 = i5;
            while (i22 < i && i10 < (this.ROUNDS + i2) * (this.BC / 8)) {
                int i23 = i5;
                while (i23 < 4) {
                    int i24 = this.BC;
                    long[] jArr3 = jArr[i10 / (i24 / 8)];
                    int i25 = i15;
                    jArr3[i23] = (((long) (bArr42[i23][i22] & 255)) << ((i10 * 8) % i24)) | jArr3[i23];
                    i23++;
                    i15 = i25;
                }
                int i26 = i15;
