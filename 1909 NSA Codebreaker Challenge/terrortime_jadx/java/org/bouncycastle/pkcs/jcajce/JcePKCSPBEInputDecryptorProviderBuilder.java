        ...
        return new InputDecryptorProvider() {
            ...
            public InputDecryptor get(AlgorithmIdentifier algorithmIdentifier) throws OperatorCreationException {
                ...
                try {
                    if (algorithm.on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
                        ...
                        if (!algorithm.equals(PKCSObjectIdentifiers.pbeWithMD5AndDES_CBC)) {
                            if (!algorithm.equals(PKCSObjectIdentifiers.pbeWithSHA1AndDES_CBC)) {
                                ...
                                sb.append("unable to create InputDecryptor: algorithm ");
                                sb.append(algorithm);
                                sb.append(" unknown.");
                                throw new OperatorCreationException(sb.toString());
                            }
                        }
                    ...
                    sb2.append("unable to create InputDecryptor: ");
                    sb2.append(e.getMessage());
                    throw new OperatorCreationException(sb2.toString(), e);
                }
            }
        };
    }
