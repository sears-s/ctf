...
public class CMSAuthenticatedDataGenerator extends CMSAuthenticatedGenerator {
    ...
    public CMSAuthenticatedData generate(CMSTypedData cMSTypedData, MacCalculator macCalculator, DigestCalculator digestCalculator) throws CMSException {
        ...
        BERSet bERSet = null;
        String str = "exception decoding algorithm parameters.";
        if (digestCalculator2 != null) {
            try {
                ...
                sb.append("unable to perform digest calculation: ");
            ...
            try {
                ...
                BERSet bERSet3 = bERSet;
                authenticatedData = new AuthenticatedData(this.originatorInfo, new DERSet(aSN1EncodableVector), macCalculator.getAlgorithmIdentifier(), null, new ContentInfo(CMSObjectIdentifiers.data, bEROctetString2), null, dEROctetString2, bERSet3);
