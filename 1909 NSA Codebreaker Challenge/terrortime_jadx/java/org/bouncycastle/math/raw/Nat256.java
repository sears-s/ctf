...
public abstract class Nat256 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 8; i < i2; i2 = 8) {
            ...
            int i4 = i + 1;
            long j21 = j2;
            long j22 = (j20 >>> 32) + (j18 * j2) + (((long) iArr3[i4]) & 4294967295L);
            iArr3[i4] = (int) j22;
            int i5 = i + 2;
            int i6 = i;
            ...
            iArr3[i8] = (int) j25;
            int i9 = i6 + 5;
            long j26 = (j25 >>> 32) + (j18 * j6) + (((long) iArr3[i9]) & 4294967295L);
            iArr3[i9] = (int) j26;
            int i10 = i6 + 6;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i53 = i52 >>> 31;
                int i54 = i2 + 15;
                iArr2[i54] = i53 | ((iArr2[i54] + ((int) (j87 >>> 32))) << 1);
                return;
            }
            i4 = i8;
            i5 = i6;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                int i28 = (int) j89;
                iArr2[14] = i27 | (i28 << 1);
                iArr2[15] = (i28 >>> 31) | ((iArr2[15] + ((int) (j89 >>> 32))) << 1);
                return;
            }
            i3 = i4;
            i = i6;
