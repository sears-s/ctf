    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        public boolean satisfiesOrder() {
            ...
            if (ECConstants.TWO.equals(cofactor)) {
                if (((org.bouncycastle.math.ec.ECFieldElement.AbstractF2m) normalize().getAffineXCoord().add(this.curve.getA())).trace() != 0) {
                    z = false;
                }
                return z;
                ...
                ECFieldElement solveQuadraticEquation = ((org.bouncycastle.math.ec.ECCurve.AbstractF2m) this.curve).solveQuadraticEquation(affineXCoord.add(this.curve.getA()));
                if (solveQuadraticEquation == null) {
                    return false;
                }
                ECFieldElement add = affineXCoord.multiply(solveQuadraticEquation).add(normalize.getAffineYCoord()).add(this.curve.getA());
                if (!(((org.bouncycastle.math.ec.ECFieldElement.AbstractF2m) add).trace() == 0 || ((org.bouncycastle.math.ec.ECFieldElement.AbstractF2m) add.add(affineXCoord)).trace() == 0)) {
                    z = false;
                }
                return z;
            }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            if (coordinateSystem == 0) {
                ...
                if (eCFieldElement8.isZero()) {
                    ...
                    eCFieldElement5 = divide2.multiply(xCoord.add(eCFieldElement4)).add(eCFieldElement4).add(yCoord).divide(eCFieldElement4).add(eCFieldElement4);
                    ...
                    eCFieldElement6 = !isOne3 ? multiply6.multiply(eCFieldElement18) : multiply6;
                    eCFieldElement5 = multiply4.add(square2).squarePlusProduct(eCFieldElement6, eCFieldElement15.add(eCFieldElement16));
                    if (!isOne2) {
                        eCFieldElement6 = eCFieldElement6.multiply(eCFieldElement16);
                    }
                    eCFieldElement4 = multiply5;
                }
                F2m f2m2 = new F2m(curve, eCFieldElement4, eCFieldElement5, new ECFieldElement[]{eCFieldElement6}, this.withCompression);
                return f2m2;
            }
        }
        ...
        public ECPoint twice() {
            ...
            if (coordinateSystem == 0) {
                ...
                F2m f2m = new F2m(eCCurve2, multiply.multiply(multiplyPlusProduct), square.square().multiplyPlusProduct(multiply, multiplyPlusProduct, add4), new ECFieldElement[]{multiply.multiply(square2)}, this.withCompression);
                return f2m;
            } else if (coordinateSystem == 6) {
                ECFieldElement eCFieldElement5 = this.y;
                ...
                if (b.bitLength() < (curve.getFieldSize() >> 1)) {
                    ...
                    if (!a.isZero()) {
                        ...
                        F2m f2m2 = new F2m(eCCurve3, square4, eCFieldElement, new ECFieldElement[]{multiply4}, this.withCompression);
                        return f2m2;
                    }
                } else {
                    if (!isOne2) {
                ...
                F2m f2m22 = new F2m(eCCurve3, square4, eCFieldElement, new ECFieldElement[]{multiply4}, this.withCompression);
                return f2m22;
            } else {
                throw new IllegalStateException("unsupported coordinate system");
            }
    ...
    public static class Fp extends AbstractFp {
        ...
        public ECPoint timesPow2(int i) {
            ...
            if (i2 < 0) {
                ...
                if (coordinateSystem == 0) {
                    ...
                    return new Fp(curve, eCFieldElement3.multiply(square), eCFieldElement5.multiply(square.multiply(invert)), this.withCompression);
                } else if (coordinateSystem == 1) {
                    Fp fp = new Fp(curve, eCFieldElement3.multiply(fromBigInteger), eCFieldElement5, new ECFieldElement[]{fromBigInteger.multiply(fromBigInteger.square())}, this.withCompression);
                    return fp;
                } else if (coordinateSystem == 2) {
                    Fp fp2 = new Fp(curve, eCFieldElement3, eCFieldElement5, new ECFieldElement[]{fromBigInteger}, this.withCompression);
                    return fp2;
                } else if (coordinateSystem == 4) {
                    Fp fp3 = new Fp(curve, eCFieldElement3, eCFieldElement5, new ECFieldElement[]{fromBigInteger, eCFieldElement4}, this.withCompression);
                    return fp3;
                } else {
                    throw new IllegalStateException(str);
                }
        ...
        public ECPoint twice() {
            ...
            if (coordinateSystem == 0) {
                ...
                Fp fp = new Fp(curve, multiply2, four.subtract(subtract2).multiply(add).subtract(two(two2.square())), new ECFieldElement[]{two(isOne ? two(two2) : two.square()).multiply(multiply)}, this.withCompression);
                return fp;
            } else if (coordinateSystem == 2) {
                ECFieldElement eCFieldElement6 = this.zs[0];
                boolean isOne2 = eCFieldElement6.isOne();
