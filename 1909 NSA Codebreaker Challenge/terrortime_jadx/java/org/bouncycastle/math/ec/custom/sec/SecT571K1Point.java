...
public class SecT571K1Point extends AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            SecT571Field.multiply(create64, create642, secT571FieldElement12.x);
            ...
            SecT571Field.multiplyPrecomp(create644, precompMultiplicand3, secT571FieldElement13.x);
            if (precompMultiplicand2 != null) {
            ...
            SecT571Field.multiplyAddToExt(create644, secT571FieldElement13.x, createExt64);
            SecT571FieldElement secT571FieldElement14 = new SecT571FieldElement(create644);
            SecT571Field.reduce(createExt64, secT571FieldElement14.x);
            if (precompMultiplicand != null) {
