...
class Tnaf {
    ...
    public static ECPoint.AbstractF2m multiplyRTnaf(ECPoint.AbstractF2m abstractF2m, BigInteger bigInteger) {
        ...
        return multiplyTnaf(abstractF2m, partModReduction(bigInteger, fieldSize, b, abstractF2m2.getSi(), mu, 10));
    }
    ...
    /* JADX INFO: used method not loaded: org.bouncycastle.math.ec.SimpleBigDecimal.compareTo(java.math.BigInteger):null, types can be incorrect */
