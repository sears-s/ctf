...
public class JCEDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public byte[] getEncoded() {
        try {
            ...
            return privateKeyInfo != null ? this.info.getEncoded(str) : new PrivateKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new ASN1Integer(getX())).getEncoded(str);
        } catch (IOException e) {
            return null;
        }
    }
